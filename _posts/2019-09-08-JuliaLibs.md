...
| Name 		| Purpose                  |  Area       | License      |	Docs | Repository |
| --------- | ------------------------ | ----------- | ------------ | ------ | ---------- |
| Plots.jl	| Visualization wrapper    |  General    | Open-Source  | [docs](http://docs.juliaplots.org/latest/) | [github](https://github.com/JuliaPlots/Plots.jl) |
