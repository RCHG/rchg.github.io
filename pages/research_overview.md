...
<div class="panel radius" markdown="1">
  ...
  {% include alert warning=' <a href="/research/publications/">Publications</a>' %}
...
---
  ...
  {% include alert info=' <a href="/research/publications/">Publications</a>' %} {% include alert warning=' <a href="/research/my-codes/">Software codes</a>' %}
